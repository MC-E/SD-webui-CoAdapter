...
from scripts.ldm.util import resize_numpy_image
...
def get_cond_model(opt, cond_type: ExtraCondition):
    if cond_type == ExtraCondition.sketch:
        from scripts.ldm.modules.extra_condition.model_edge import pidinet
        model = pidinet()
        ...
        from scripts.ldm.modules.extra_condition.midas.api import MiDaSInference
        ...
        from scripts.ldm.modules.extra_condition.openpose.api import OpenposeInference
...
def get_cond_keypose(opt, cond_image, cond_inp_type='image', cond_model=None):
    ...
    if cond_inp_type == 'keypose':
        ...
        from scripts.ldm.modules.extra_condition.utils import imshow_keypoints
